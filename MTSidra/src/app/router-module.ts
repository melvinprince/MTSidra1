...
export const router: Routes = [
    ...
    { path: 'ticket', component: TicketInfoContainerComponent},    
    { path: 'ticket_loading', component: TicketLoaderComponent},    
    { path: 'passport', component: PassportComponent },
    { path: 'landing', component: ApptValComponent },
    { path: 'women', component: ApptValComponent },
    { path: 'plazaPharmacy', component: ApptValComponent },
    { path: 'womenPharmacy', component: ApptValComponent },
    { path: 'apptList', component: ApptListComponent },
    { path: 'walkin', component: WalkinComponent },
    { path: 'mobileentry', component: MobileEntryComponent,  },
    { path: 'ticketinfo', component: TicketComponent, canActivate: [AuthGuard] },
    { path: '**', component: UnautherizedComponent}
