...
var MobileTicketAPI = (function () {
  ...
  $.ajaxSetup({
    beforeSend: function (xhr) {
      ...
      xhr.setRequestHeader("auth-token", "9ee77e56-8e59-4843-91aa-d69a9d1cafce"); //Change the api token with your one      
    }
  });
  ...
  function resetAllVars() {
    ...
    MobileTicketAPI.custom1 = undefined;
    MobileTicketAPI.custom2 = undefined;
    MobileTicketAPI.level = undefined;
    MobileTicketAPI.sidapptId = undefined;
  ...
  return {
	...
	//kisho
	getQueueInfo: function (queueId,onSuccess, onError) {
		//debugger;
		try {
			try{
				var branch = JSON.parse(localStorage.getItem("branch"));
		  ...
		  var SERVICES_REST_API =   "rest/entrypoint/" + BRANCHES + "/" + branch.id + "/queues/" + queueId ;
		  $.ajax({
			type: "GET",
			dataType: "json",
			url: SERVICES_REST_API,
	  ...
	  getServiceInfo: function (serviceId,onSuccess, onError) {
		//debugger;
		try {
			try{
				var branch = JSON.parse(localStorage.getItem("branch"));
		  ...
		  var SERVICES_REST_API =   "rest/entrypoint/" + BRANCHES + "/" + branch.id + "/services/" + serviceId ;
		  $.ajax({
			type: "GET",
			dataType: "json",
			url: SERVICES_REST_API,
    ...
    createVisit: function (onSuccess, onError) {
      ...
      try {
        ...
        var jsonData = {};
		//kisho
        var custom1 = this.getCustom1();
        var custom2 = this.getCustom2();
        var custom3 = this.getCustom3();
        var custom4 = this.getCustom4();
        var custom5 = this.getCustom5();
        var level = this.getlevel();
        var sidapptId = this.getsidapptId();
		//k
        ...
        if (enteredPhoneNum && enteredPhoneNum.length > 0 || enteredCustomerId && enteredCustomerId.length > 0 || fingerPrint || custom3 || custom4 || enteredFirstName || enteredLastName) {
          jsonData.parameters = {};
           ...
           if (custom1 && custom1.length > 0) {
            jsonData.parameters.custom1 = custom1;
           }
           if (custom2 && custom2.length > 0) {
            jsonData.parameters.custom2 = custom2;
           }
		   ...
		   if (custom5 && custom5.length > 0) {
            jsonData.parameters.custom5 = custom5;
           }
           if (level && level.length > 0) {
            jsonData.parameters.level = level;
           }
		   if (sidapptId && sidapptId.length > 0) {
            jsonData.parameters.sidapptId = sidapptId;
           }
	...
	customCreateVisit: function (params,onSuccess, onError) {
		//debugger;
      try {
		//kisho
        //var branch = getSelectedBranch();
        ...
        var jsonData = {};
		jsonData.parameters={};
		jsonData.parameters=params.parameters;
	...
	getAppt: function (body_, onSuccess, onError) {
		//debugger;
		try {
		  var SERVICES_REST_API = "mt/PublicAPI/getAppt";
		   $.ajax({
			type: "POST",
			url: SERVICES_REST_API,
			contentType: 'application/json',
	...
	setCustom1:function(custom1){
		MobileTicketAPI.custom1=custom1;
	},
	getCustom1:function(){
		return MobileTicketAPI.custom1;
	},
	setCustom2:function(custom2){
		MobileTicketAPI.custom2=custom2;
	},
	getCustom2:function(){
		return MobileTicketAPI.custom2;
	},
	setsidapptId:function(sidapptId){
		MobileTicketAPI.sidapptId=sidapptId;
	},
	getsidapptId:function(){
		return MobileTicketAPI.sidapptId;
	},
	//k
	//kisho
	setlevel:function(level){
		MobileTicketAPI.level=level;
	},
	getlevel:function(){
		return MobileTicketAPI.level;
	},
	//k
